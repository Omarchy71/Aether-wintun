...
pub fn log_summary() {
    ...
    log::info!(
        "[*] performance profile: {:?} (cpus={} mem={}); scan concurrency cap={}, udp socket rcv/snd={}KB/{}KB, netstack tcp buffers={}KB rx/{}KB tx, netstack udp buffer={}KB, channel capacity={}, h2 windows={}KB/{}KB",
        t.tier,
        t.cpus,
        mem,
        cap,
